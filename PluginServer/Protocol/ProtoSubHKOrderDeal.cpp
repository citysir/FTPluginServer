...
CProtoSubHKOrderDeal::CProtoSubHKOrderDeal()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoSubHKOrderDeal::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoSubHKOrderDeal::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoSubHKOrderDeal::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoSubHKOrderDeal::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoSubHKOrderDeal::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoSubHKOrderDeal::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoSubHKOrderDeal::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoSubHKOrderDeal::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoSubHKOrderDeal::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoSubHKOrderDeal::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoSubHKOrderDeal::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
...
//tomodify 8
void CProtoSubHKOrderDeal::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE, FALSE, FALSE,
		FALSE, FALSE,
