...
CProtoPushUSOrder::CProtoPushUSOrder()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoPushUSOrder::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoPushUSOrder::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoPushUSOrder::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoPushUSOrder::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoPushUSOrder::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoPushUSOrder::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoPushUSOrder::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoPushUSOrder::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoPushUSOrder::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoPushUSOrder::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoPushUSOrder::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
}

//tomodify 8
void CProtoPushUSOrder::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	...
	static LPCSTR arFieldKey[] = {		
		...
		"SubmitedTime", "UpdatedTime",
		"StockCode", "StockName",
	};

	ProtoAckBodyType &body = const_cast<ProtoAckBodyType &>(ackData);
	void *arPtr[] = {
		&body.nEnvType,	&body.USOrderItem.nOrderID, 
		&body.USOrderItem.nOrderType, &body.USOrderItem.enSide, &body.USOrderItem.nStatus,
		&body.USOrderItem.nPrice, &body.USOrderItem.nQty, &body.USOrderItem.nDealtQty, &body.USOrderItem.nDealtAvgPrice,
		&body.USOrderItem.nSubmitedTime, &body.USOrderItem.nUpdatedTime,
		&body.USOrderItem.strStockCode, &body.USOrderItem.strStockName,
	};
