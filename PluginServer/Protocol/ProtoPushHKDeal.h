...
class CProtoPushHKDeal : public CProtoParseBase
{
public:
	//tomodify 1
	typedef PushHKDeal_Req		ProtoReqDataType;
	typedef PushHKDeal_Ack		ProtoAckDataType;

	//tomodify 2
	typedef PushHKDealReqBody	ProtoReqBodyType;
	typedef PushHKDealAckBody	ProtoAckBodyType;

public:
	CProtoPushHKDeal();
	virtual ~CProtoPushHKDeal();
