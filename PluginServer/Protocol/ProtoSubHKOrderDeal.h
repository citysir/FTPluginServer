...
class CProtoSubHKOrderDeal : public CProtoParseBase
{
public:
	//tomodify 1
	typedef SubHKOrderDeal_Req		ProtoReqDataType;
	typedef SubHKOrderDeal_Ack		ProtoAckDataType;

	//tomodify 2
	typedef SubHKOrderDealReqBody	   ProtoReqBodyType;
	typedef SubHKOrderDealAckBody	   ProtoAckBodyType;


public:
	CProtoSubHKOrderDeal();
	virtual ~CProtoSubHKOrderDeal();
