...
class CProtoPushHKOrder : public CProtoParseBase
{
public:
	//tomodify 1
	typedef PushHKOrder_Req		ProtoReqDataType;
	typedef PushHKOrder_Ack		ProtoAckDataType;

	//tomodify 2
	typedef PushHKOrderReqBody	ProtoReqBodyType;
	typedef PushHKOrderAckBody	ProtoAckBodyType;


public:
	CProtoPushHKOrder();
	virtual ~CProtoPushHKOrder();
