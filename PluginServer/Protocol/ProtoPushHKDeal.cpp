...
CProtoPushHKDeal::CProtoPushHKDeal()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoPushHKDeal::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoPushHKDeal::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoPushHKDeal::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoPushHKDeal::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoPushHKDeal::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoPushHKDeal::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoPushHKDeal::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoPushHKDeal::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoPushHKDeal::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoPushHKDeal::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoPushHKDeal::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
}

//tomodify 8
void CProtoPushHKDeal::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	...
	void *arPtr[] = {
		...
		&body.nContraBrokerID, &body.strContraBrokerName,
	};
