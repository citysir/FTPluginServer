...
class CProtoSubUSOrderDeal : public CProtoParseBase
{
public:
	//tomodify 1
	typedef SubUSOrderDeal_Req		ProtoReqDataType;
	typedef SubUSOrderDeal_Ack		ProtoAckDataType;

	//tomodify 2
	typedef SubUSOrderDealReqBody	   ProtoReqBodyType;
	typedef SubUSOrderDealAckBody	   ProtoAckBodyType;


public:
	CProtoSubUSOrderDeal();
	virtual ~CProtoSubUSOrderDeal();
