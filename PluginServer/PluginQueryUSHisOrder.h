...
class CPluginQueryUSHisOrder : public CTimerWndInterface, public CMsgHandlerEventInterface
{
public:
	CPluginQueryUSHisOrder();
	virtual ~CPluginQueryUSHisOrder();
	...
	void NotifyOnQueryUSHisOrder(Trade_Env enEnv, UINT32 nCookie, INT32 nCount, const Trade_OrderItem* pArrOrder);
...
protected:
	//tomodify 1
	typedef QueryUSHisOrder_Req	TradeReqType;
	typedef QueryUSHisOrder_Ack	TradeAckType;
	typedef QueryUSHisOrderAckItem TradeAckItemType;
